    ...
    <div class="container">
        ...
        <main>
            ...
            <div class="cards" id="cards">
                ...
                <div class="leftCard">
                    <pre> Username: <input type="text" name="username" value="<?php echo htmlspecialchars($row['username']); ?>" disabled></pre>
                    <pre> Email: <input type="text" name="email" value="<?php echo htmlspecialchars($row['email']); ?>" disabled></pre>
                </div>

                <div class="rightCard">
                    <pre> Number:<input type="text" name="number" value="<?php echo htmlspecialchars($row['phoneNum']); ?>" disabled></pre>
                    <pre> Address:<input type="text" name="address" value="<?php echo htmlspecialchars($row['address']); ?>" disabled></pre>
                </div>
